...
import BackUp from "../assets/images/backupimage.jpg"
...
export const MovieDetail = () => {
    ...
    useEffect(() => {
        async function fetchMovie() {
            const response = await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=c424222e373522be4e2b3b4821362791`);
    ...
    useEffect(() => {
        document.title = `${movie.title}/Cinebry`;
    });
